const products = [
    ...
    { id: 906, name: "تيشيرت ساده - موديل 6", price: 80, category: "men", subCategory: "tshirts", image: "https://placehold.co/600x800/1a1a1a/ffffff?text=T-shirt+5", badge: "BEST", sizes: ["s", "L", "XL", "XXL"], colors: ["برتقالي", "أسود"] },
    // Polos (5)
